...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Set<String> treeSetComparador = setsClase.construirTreeSetConComparador();
        System.out.println(treeSetComparador);
        System.out.println(treeSetComparador.size());
        System.out.println(treeSetComparador.contains("A"));
